...
\section{section b}
\begin{enumerate}
\item[31.]  A hyperbola passes through point  p($\sqrt2,\sqrt2$)  and  has  foci  at 
...
\item[38.] Let 0$<$$\theta$$<$$\pi/2$  .If the eccentricty of the hyperbola $\frac{x^2}{cos^2\theta}$ - $\frac{y^2}{sin^2\theta}$ = 1 is greater than 2, then the length of its latus rectum lies in the interval:
...
\item[40.] If the line y=mx+7$\sqrt{3}$ is normal to the hyperbola $\frac{x^2}{24}$-$\frac{y^2}{18}$ then a value of m is: 
