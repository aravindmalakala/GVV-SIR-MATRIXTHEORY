...
\title{2021-July Session-20-07-2021-shift-2-21-30}
...
\item The number of solutions of the equation $\log_{\brak{x+1}}^{\brak{2x^2+7x+5}}+\log_{\brak{2x+5}}^{\brak{x+1}^2}-4=0$, $x>0$, is 
