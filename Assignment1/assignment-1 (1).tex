...
\begin{enumerate}[start=31]
 ...
 \item A hyperbola passes through point $\vec{p(\sqrt2,\sqrt2)}$  and  has  foci  at $\vec{(\pm2,0)}$. Then  the  tangent  to  this  hyperbola at P also passes through the point :
...
\begin{enumerate}
    \item  ($-\sqrt2,-\sqrt3$)
    \item  ($3\sqrt2,2\sqrt3$)
    \item ($2\sqrt2,3\sqrt3$)
    \item  ($\sqrt3,\sqrt2$)
\end{enumerate}
\end{multicols}
\item  The radius of a circle, having minimum area, which touches the curve $y=4-x^2$ and the lines ,$y=|{x}|$ is : 
...
\item Tangents are drawn to the hyperbola 4$x^2-y^2$=36 at the points P and Q. If  these tangents intersect  at the point $\vec{T(0,3)}$ then the area (in sq.units) of $\Delta$ PTQ is:
...
\end{enumerate}
\end{multicols}
\item tangent and normal are drawn at $\vec{P(16,16)}$ on the parabola $y^2=16x$,
...
A=\{(a,b)$\in$$\mathbb{R}X\mathbb{R}$ : $|{a-5}|<1$ and $|{b-5}|<1$\};\\
B=\{(a,b)$\in$$\mathbb{R}X\mathbb{R}$ : 4$(a-6)^2$ + 9$(b-5)^2$$\leq$36\}.Then:
...
\item If the tangent at $\vec{(1,7)}$ to the curve $x^2=y-6$ touches the circle $x^2+y^2+16x+12y+c=0$ then the value of c is :
...
\end{enumerate}   
\end{multicols}
\item if one end of a focal chord of the parabola,$y^2=16x$ is at $\vec{(1,4)}$,then the length of this focal chord is :
