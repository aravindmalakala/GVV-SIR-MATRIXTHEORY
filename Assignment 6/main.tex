...
{\let\newpage\relax\maketitle}
 \textbf{Question}:\\ Write true or false in each of the following. Give reasons for your answer\\
 \begin{enumerate}
 \item A triangle can be constructed in wich $\vec{AB}=5cm$, $\angle A=45\degree$ and $\vec{BC}+\vec{AC}=5cm$
\\
\solution \\
\begin{table}[!ht]
   \centering
...
\\
\item A triangle can be constructed in which $\vec{BC}=6cm$, $\angle B=30\degree$ and $\vec{AC}-\vec{AB}=4cm$.
\\
\solution \\
\begin{table}[!ht]
   \centering
...
\item A triangle can be constructed in which $\angle B = 105\degree$, $\angle C = 90\degree$ and $\vec{AB}+\vec{BC}+\vec{AC} =10cm$
\\
\solution \\
\begin{table}[!ht]
   \centering
